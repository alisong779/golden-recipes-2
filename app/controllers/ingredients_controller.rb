class IngredientsController < ApplicationController
  ...
  def create
    if ingredient_params[:recipe_id]
      ...
      @recipe.recipe_ingredients.build(:ingredient_id => @ingredient.id, :quantity => ingredient_params[:recipe_ingredient][:quantity], :unit => ingredient_params[:recipe_ingredient][:unit])
      if @recipe.save!
